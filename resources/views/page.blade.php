...
<head>
    ...
    <title>{{ $page->getTranslation('title', app()->getLocale()) }} - {{ __('site_title') }}</title>
                                ...
                                <ul>
                                    ...
                                    @foreach(\App\Models\Page::where('is_active', true)->orderBy('order')->get() as $p)
                                        <li><a href="{{ route('page.show', $p->slug) }}"
                                                class="{{ request()->is($p->slug) ? 'active' : '' }}">{{ $p->getTranslation('title', app()->getLocale()) }}</a>
                                        </li>
                                    @endforeach
                ...
                <div id="Body">
                    <div id="Content">
                        ...
                        <div id="Dynamic_Page_Content"
                            style="padding: 30px; background: #fff; min-height: 200px; border-bottom: 2px solid #3498db; margin-bottom: 20px;">
                            <h1
                                style="color: #2c3e50; font-size: 28px; border-bottom: 1px solid #eee; padding-bottom: 15px; margin-bottom: 20px; {{ app()->getLocale() === 'ar' ? 'text-align: right;' : 'text-align: left;' }}">
                                {{ $page->getTranslation('title', app()->getLocale()) }}
                            </h1>

                            <div class="Page_Text"
                                style="line-height: 1.8; color: #555; {{ app()->getLocale() === 'ar' ? 'text-align: right;' : 'text-align: left;' }}">
                                <!-- Additional page content could go here if the model supported a 'content' field -->
                                <p>{{ __('Welcome to our') }} {{ $page->getTranslation('title', app()->getLocale()) }}
                                    {{ __('page') }}.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="Our_Services">
                            @if($services->count() > 0)
                                <div class="Our_Services">
                                    <h2
                                        style="text-align: center; margin-bottom: 30px; color: #3498db; font-size: 24px; text-transform: uppercase;">
                                        {{ __('Our Services') }}
                                    </h2>
                                    <ul>
